...
void gocPhanTu ( Diem a[] , int n )
{
    for ( int i = 0 ; i < n ; i++ )
        {
            if ( a[ i ].x == 0 && a[ i ].y == 0 )
                cout << "("<<a[ i ].x<<","<<a[ i ].y<<") la goc toa do\n" ;
            else if ( a[ i ].x > 0 && a[ i ].y > 0 )
                cout << "("<<a[ i ].x<<","<<a[ i ].y<<") thuoc goc phan tu thu I\n" ;
            else if ( a[ i ].x < 0 && a[ i ].y < 0 )
                cout << "("<<a[ i ].x<<","<<a[ i ].y<<") thuoc goc phan tu thu III\n" ;
            else if ( a[ i ].x < 0 && a[ i ].y > 0 )
                cout << "("<<a[ i ].x<<","<<a[ i ].y<<") thuoc goc phan tu thu II\n" ;
            else if ( a[ i ].x > 0 && a[ i ].y < 0 )
                cout << "("<<a[ i ].x<<","<<a[ i ].y<<") thuoc goc phan tu thu IV\n" ;
            else if ( a[ i ].x == 0 && a[ i ].y != 0 ) 
                cout << "("<<a[ i ].x<<","<<a[ i ].y<<") nam tren truc tung\n" ;
            else if ( a[ i ].x != 0 && a[ i ].y == 0 ) 
                cout << "("<<a[ i ].x<<","<<a[ i ].y<<") nam tren truc hoanh\n" ;
        }
}
